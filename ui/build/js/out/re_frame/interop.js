...
return [(function (){var pred__5423 = cljs.core.instance_QMARK_;
var expr__5424 = reactive_val;
if(cljs.core.truth_((pred__5423.cljs$core$IFn$_invoke$arity$2 ? pred__5423.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__5424) : pred__5423.call(null,reagent.ratom.RAtom,expr__5424)))){
return "ra";
} else {
if(cljs.core.truth_((pred__5423.cljs$core$IFn$_invoke$arity$2 ? pred__5423.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__5424) : pred__5423.call(null,reagent.ratom.RCursor,expr__5424)))){
return "rc";
} else {
if(cljs.core.truth_((pred__5423.cljs$core$IFn$_invoke$arity$2 ? pred__5423.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__5424) : pred__5423.call(null,reagent.ratom.Reaction,expr__5424)))){
return "rx";
} else {
if(cljs.core.truth_((pred__5423.cljs$core$IFn$_invoke$arity$2 ? pred__5423.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__5424) : pred__5423.call(null,reagent.ratom.Track,expr__5424)))){
return "tr";
} else {
return "other";
}
