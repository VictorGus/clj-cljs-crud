...
var G__5218_5221 = reagent.impl.template.prop_name_cache;
var G__5219_5222 = cljs.core.name(k);
var G__5220_5223 = v;
goog.object.set(G__5218_5221,G__5219_5222,G__5220_5223);
...
var G__5224 = o;
var G__5225_5228 = G__5224;
var G__5226_5229 = reagent.impl.template.cached_prop_name(k);
var G__5227_5230 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__5225_5228,G__5226_5229,G__5227_5230);
...
var G__5232__i = 0, G__5232__a = new Array(arguments.length -  0);
while (G__5232__i < G__5232__a.length) {G__5232__a[G__5232__i] = arguments[G__5232__i + 0]; ++G__5232__i;}
  args = new cljs.core.IndexedSeq(G__5232__a,0,null);
} 
return G__5231__delegate.call(this,args);};
G__5231.cljs$lang$maxFixedArity = 0;
G__5231.cljs$lang$applyTo = (function (arglist__5233){
var args = cljs.core.seq(arglist__5233);
...
if((temp__5722__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__5234_5237 = reagent.impl.template.custom_prop_name_cache;
var G__5235_5238 = cljs.core.name(k);
var G__5236_5239 = v;
goog.object.set(G__5234_5237,G__5235_5238,G__5236_5239);
...
var G__5240 = o;
var G__5241_5244 = G__5240;
var G__5242_5245 = reagent.impl.template.cached_custom_prop_name(k);
var G__5243_5246 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__5241_5244,G__5242_5245,G__5243_5246);
...
var args = null;
if (arguments.length > 0) {
var G__5248__i = 0, G__5248__a = new Array(arguments.length -  0);
while (G__5248__i < G__5248__a.length) {G__5248__a[G__5248__i] = arguments[G__5248__i + 0]; ++G__5248__i;}
  args = new cljs.core.IndexedSeq(G__5248__a,0,null);
} 
return G__5247__delegate.call(this,args);};
G__5247.cljs$lang$maxFixedArity = 0;
G__5247.cljs$lang$applyTo = (function (arglist__5249){
...
var G__5250 = props;
var G__5250__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5250,cljs.core.cst$kw$id,id):G__5250);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5250__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__5250__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__5251 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__5251,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__5251;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__5252){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5253__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__5253,map__5253__$1,on_write){
return (function (){
...
});})(node_value,map__5253,map__5253__$1,on_write))
);
} else {
...
return (function (p1__5255_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__5255_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__5258 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5258,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5258,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5258,(2),null);
...
var temp__5724__auto___5262 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___5262 == null)){
} else {
var key_5263 = temp__5724__auto___5262;
jsprops.key = key_5263;
}
...
var temp__5724__auto___5264 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___5264 == null)){
} else {
var key_5265 = temp__5724__auto___5264;
jsprops.key = key_5265;
}
...
var G__5266 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__5266) : reagent.impl.template.as_element.call(null,G__5266));
} else {
var temp__5724__auto___5267 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5724__auto___5267 == null)){
} else {
var key_5268 = temp__5724__auto___5267;
jsprops.key = key_5268;
}
...
var G__5270 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__5270)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__5270)){
return x;
} else {
...
var len__4730__auto___5273 = arguments.length;
var i__4731__auto___5274 = (0);
while(true){
if((i__4731__auto___5274 < len__4730__auto___5273)){
args__4736__auto__.push((arguments[i__4731__auto___5274]));

var G__5275 = (i__4731__auto___5274 + (1));
i__4731__auto___5274 = G__5275;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq5271){
...
break;
default:
var G__5278 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__5278;
continue;
...
var ctx = ({});
var vec__5280 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5280,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__5280,(1),null);
...
var G__5283 = (cljs.core.count(argv) - first_child);
switch (G__5283) {
case (0):
...
break;
case (1):
var G__5284 = component;
var G__5285 = jsprops;
var G__5286 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__5284,G__5285,G__5286) : reagent.impl.template.global$module$react.createElement.call(null,G__5284,G__5285,G__5286));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__5283){
