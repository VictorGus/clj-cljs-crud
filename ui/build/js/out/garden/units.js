 ...
 */
garden.units.convert = (function garden$units$convert(p__7857,right){
...
var m = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7858__$1,cljs.core.cst$kw$magnitude);
var left = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7858__$1,cljs.core.cst$kw$unit);
...
var vec__7860 = temp__5720__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7860,(0),null);
var magnitude = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7860,(1),null);
var unit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7860,(2),null);
...
var map__7863 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7863__$1,cljs.core.cst$kw$magnitude);
var map__7864 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
var map__7864__$1 = (((((!((map__7864 == null))))?(((((map__7864.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7864.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7864):map__7864);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7864__$1,cljs.core.cst$kw$magnitude);
var G__7867 = (m1 + m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7867) : u.call(null,G__7867));
});
...
var G__7869__i = 0, G__7869__a = new Array(arguments.length -  2);
while (G__7869__i < G__7869__a.length) {G__7869__a[G__7869__i] = arguments[G__7869__i + 2]; ++G__7869__i;}
  more = new cljs.core.IndexedSeq(G__7869__a,0,null);
} 
...
var more = cljs.core.rest(arglist__7870);
...
var G__7871 = null;
if (arguments.length > 2) {
var G__7872__i = 0, G__7872__a = new Array(arguments.length -  2);
while (G__7872__i < G__7872__a.length) {G__7872__a[G__7872__i] = arguments[G__7872__i + 2]; ++G__7872__i;}
G__7871 = new cljs.core.IndexedSeq(G__7872__a,0,null);
}
return garden$units$make_unit_adder_$_u_PLUS___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__7871);
}
...
var G__7873 = (- x);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7873) : u.call(null,G__7873));
});
var garden$units$make_unit_subtractor_$_u___2 = (function (x,y){
var map__7874 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
var map__7874__$1 = (((((!((map__7874 == null))))?(((((map__7874.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7874.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7874):map__7874);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7874__$1,cljs.core.cst$kw$magnitude);
var map__7875 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
var map__7875__$1 = (((((!((map__7875 == null))))?(((((map__7875.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7875.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7875):map__7875);
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7875__$1,cljs.core.cst$kw$magnitude);
var G__7878 = (m1 - m2);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7878) : u.call(null,G__7878));
});
...
while (G__7880__i < G__7880__a.length) {G__7880__a[G__7880__i] = arguments[G__7880__i + 2]; ++G__7880__i;}
  more = new cljs.core.IndexedSeq(G__7880__a,0,null);
} 
...
G__7882 = new cljs.core.IndexedSeq(G__7883__a,0,null);
}
return garden$units$make_unit_subtractor_$_u___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__7882);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var map__7884 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
var map__7884__$1 = (((((!((map__7884 == null))))?(((((map__7884.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7884.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7884):map__7884);
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7884__$1,cljs.core.cst$kw$magnitude);
var map__7885 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7885__$1,cljs.core.cst$kw$magnitude);
var G__7888 = (op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2));
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7888) : u.call(null,G__7888));
});
var garden$units$make_unit_multiplier_$_u_STAR___3 = (function() { 
var G__7889__delegate = function (x,y,more){
...
while (G__7890__i < G__7890__a.length) {G__7890__a[G__7890__i] = arguments[G__7890__i + 2]; ++G__7890__i;}
  more = new cljs.core.IndexedSeq(G__7890__a,0,null);
} 
return G__7889__delegate.call(this,x,y,more);};
...
var more = cljs.core.rest(arglist__7891);
return G__7889__delegate(x,y,more);
});
...
G__7892 = new cljs.core.IndexedSeq(G__7893__a,0,null);
}
return garden$units$make_unit_multiplier_$_u_STAR___3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__7892);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
...
var G__7894 = ((1) / x);
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7894) : u.call(null,G__7894));
});
var garden$units$make_unit_divider_$_ud__2 = (function (x,y){
var map__7895 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(x) : u.call(null,x));
...
var m1 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7895__$1,cljs.core.cst$kw$magnitude);
var map__7896 = (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(y) : u.call(null,y));
...
var m2 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7896__$1,cljs.core.cst$kw$magnitude);
var G__7899 = (op.cljs$core$IFn$_invoke$arity$2 ? op.cljs$core$IFn$_invoke$arity$2(m1,m2) : op.call(null,m1,m2));
return (u.cljs$core$IFn$_invoke$arity$1 ? u.cljs$core$IFn$_invoke$arity$1(G__7899) : u.call(null,G__7899));
});
...
while (G__7901__i < G__7901__a.length) {G__7901__a[G__7901__i] = arguments[G__7901__i + 2]; ++G__7901__i;}
  more = new cljs.core.IndexedSeq(G__7901__a,0,null);
} 
...
return G__7900__delegate(x,y,more);
});
...
G__7903 = new cljs.core.IndexedSeq(G__7904__a,0,null);
}
return garden$units$make_unit_divider_$_ud__3.cljs$core$IFn$_invoke$arity$variadic(x,y, G__7903);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
